...
- [x] I completed the prerequisites for this deliverable (Simon deployed, GitHub link, Git commits)
- [x] **Stores data in MongoDB** - Login and account data and game data now stored in Database
- [x] **Stores credentials in MongoDB** - login credentials are stored and accessed through Database
